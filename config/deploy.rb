...
set :application, "merengue" #FIXME
...
set :scm, :git
set :repository,  "git@github.com:allanRoberto/merengue.git" #FIXME
# set :scm, :subversion
...
set :local_path, "/Users/Allan/sites/merengue" #FIXME
...
set :local_domain, 'merengue.art.com.br' #FIXME
