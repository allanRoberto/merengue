...
<style type='text/css'>
	...
	.wp-nutrition-label .heading { font-size: 2.2em; font-weight: 900; margin: 0; line-height: 1em; }
...
function nutr_label_generate( $id, $width = 22 ) 
{
	...
	$rtn .= "	<div class='heading'>".__("Valor Nutricional")."</div>\n";
	...
	$rtn .= "		<span class='f-left'>" . __("Calorias") . " " . $calories . "</span>\n";
	$rtn .= "		<span class='f-right'>Calories from Fat " . ($totalfat * 9) . "</span>\n";
	$rtn .= "	</div>\n";
	
	$rtn .= "	<div class='item_row daily-value small'>% " . __("VD") . "*</div>\n";
	
	$rtn .= "	<div class='item_row cf'>\n";
	$rtn .= "		<span class='f-left'><strong>" . __("Gorduras totais") . "</strong> " . $totalfat . "g</span>\n";
	$rtn .= "		<span class='f-right'>" . nutr_percentage($totalfat, $rda['totalfat']) . "%</span>\n";
	$rtn .= "	</div>\n";
	
	$rtn .= "	<div class='indent item_row cf'>\n";
	$rtn .= "		<span class='f-left'>" . __("Gorduras saturadas") . " " . $satfat . "g</span>\n";
	$rtn .= "		<span class='f-right'>" . nutr_percentage($satfat, $rda['satfat']) . "%</span>\n";
	$rtn .= "	</div>\n";
	
	$rtn .= "	<div class='indent item_row cf'>\n";
	$rtn .= "		<span>" . __("Gorduras Trans") . " " . $transfat . "g</span>";
	$rtn .= "	</div>\n";
	
	$rtn .= "	<div class='item_row cf'>\n";
	$rtn .= "		<span class='f-left'><strong>" . __("Colesterol") . "</strong> " . $cholesterol . "mg</span>\n";
	$rtn .= "		<span class='f-right'>" . nutr_percentage($cholesterol, $rda['cholesterol']) . "%</span>\n";
	$rtn .= "	</div>\n";
	
	$rtn .= "	<div class='item_row cf'>\n";
	$rtn .= "		<span class='f-left'><strong>" . __("Sódio")."</strong> " . $sodium . "mg</span>\n";
	$rtn .= "		<span class='f-right'>" . nutr_percentage($sodium, $rda['sodium']) . "%</span>\n";
	$rtn .= "	</div>\n";
	
	$rtn .= "	<div class='item_row cf'>\n";
	$rtn .= "		<span class='f-left'><strong>" . __("Carboidratos") . "</strong> " . $carbohydrates . "g</span>\n";
	...
	$rtn .= "	<div class='item_row cf'>\n";
	$rtn .= "		<span class='f-left'><strong>".__("Proteína")."</strong> ".$protein."g</span>\n";
